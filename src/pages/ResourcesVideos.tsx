...
const ResourcesVideos = () => {
  ...
  return (
    <div className="min-h-screen overflow-hidden bg-background text-foreground">
      ...
      <main>
        <section className="relative border-b border-slate-800 bg-slate-950 pb-20 pt-28 text-white sm:pt-32 lg:pb-28">
          <div className="pointer-events-none absolute inset-0 overflow-hidden" aria-hidden="true">
            ...
            <div className="absolute -right-32 bottom-0 h-80 w-80 rounded-full bg-emerald-400/10 blur-[100px]" />
          ...
          <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mx-auto mb-12 max-w-4xl text-center">
              <div className="mb-5 inline-flex items-center gap-2 rounded-full border border-sky-400/20 bg-sky-400/10 px-4 py-2 text-xs font-semibold uppercase tracking-[0.18em] text-sky-300">
            ...
            <article className="mx-auto max-w-6xl">
              <div className="overflow-hidden rounded-2xl border border-white/10 bg-slate-900 shadow-[0_30px_100px_-35px_rgba(14,165,233,0.65)] sm:rounded-3xl">
                <div className="flex items-center gap-2 border-b border-white/10 bg-slate-900/90 px-4 py-3">
                  <span className="h-2.5 w-2.5 rounded-full bg-rose-400/70" />
                  <span className="h-2.5 w-2.5 rounded-full bg-amber-300/70" />
                  <span className="h-2.5 w-2.5 rounded-full bg-emerald-400/70" />
                  <span className="ml-3 text-xs font-medium text-slate-400">Insight Matches platform walkthrough</span>
                </div>
              ...
              <div className="mt-7 flex flex-col gap-5 sm:flex-row sm:items-start sm:justify-between">
                <div className="max-w-3xl">
                  ...
                  <p className="mt-3 leading-7 text-slate-300">{longVideo.description}</p>
                </div>
                <a
                  href={longVideo.youtubeUrl}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex shrink-0 items-center justify-center gap-2 rounded-full border border-white/15 bg-white/5 px-5 py-3 text-sm font-semibold text-white transition hover:border-sky-300/50 hover:bg-sky-400/10"
                >
        ...
        <section className="relative py-20 sm:py-24">
          <div className="mx-auto grid max-w-6xl items-center gap-12 px-4 sm:px-6 lg:grid-cols-[minmax(0,1fr)_360px] lg:gap-20 lg:px-8">
            ...
            <div className="relative mx-auto w-full max-w-[320px] lg:max-w-none">
              ...
              <div className="relative overflow-hidden rounded-[2.25rem] border-[7px] border-slate-950 bg-black shadow-2xl ring-1 ring-slate-900/15">
                <div className="absolute left-1/2 top-2 z-10 h-5 w-20 -translate-x-1/2 rounded-full bg-slate-950" aria-hidden="true" />
