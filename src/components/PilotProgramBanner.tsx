    ...
    <section className="pt-32 pb-16 lg:pt-40 lg:pb-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8 mb-12">
          ...
          <div className="bg-card border border-border rounded-xl p-6 lg:p-8 hover:shadow-lg transition-all duration-300 card-hover">
            <div className="flex items-center gap-3 mb-6">
              <div className="p-3 rounded-lg bg-gradient-to-br from-mint-100 to-mint-200 dark:from-mint-900/30 dark:to-mint-800/30">
                <Calendar className="w-6 h-6 text-mint-600 dark:text-mint-400" />
              </div>
              <h3 className="font-playfair text-2xl font-bold text-foreground">{t('atAGlance')}</h3>
            </div>
            <ul className="space-y-4">
              <li>
                <div className="flex items-start gap-3">
                  <div className="mt-1.5 w-2 h-2 rounded-full bg-gradient-to-r from-mint-500 to-lavender-500 flex-shrink-0"></div>
                  <div>
          ...
          <div className="bg-card border border-border rounded-xl p-6 lg:p-8 hover:shadow-lg transition-all duration-300 card-hover">
            <div className="flex items-center gap-3 mb-6">
              <div className="p-3 rounded-lg bg-gradient-to-br from-lavender-100 to-lavender-200 dark:from-lavender-900/30 dark:to-lavender-800/30">
                <Lightbulb className="w-6 h-6 text-lavender-600 dark:text-lavender-400" />
              </div>
              <h3 className="font-playfair text-2xl font-bold text-foreground">{t('whatYoullExperience')}</h3>
            </div>
            <ul className="space-y-4">
              <li>
                <div className="flex items-start gap-3">
          ...
          <div className="bg-card border border-border rounded-xl p-6 lg:p-8 hover:shadow-lg transition-all duration-300 card-hover">
            <div className="flex items-center gap-3 mb-6">
              <div className="p-3 rounded-lg bg-gradient-to-br from-mint-100 to-lavender-100 dark:from-mint-900/30 dark:to-lavender-900/30">
                <Target className="w-6 h-6 text-mint-600 dark:text-mint-400" />
              </div>
              <h3 className="font-playfair text-2xl font-bold text-foreground">{t('ourPilotGoals')}</h3>
            </div>
            <ul className="space-y-4">
              <li>
                <div className="flex items-start gap-3">
        ...
        <div className="text-center animate-fade-in">
          <a href="/request-demo"
            className="inline-flex items-center justify-center px-10 py-5 rounded-lg font-bold font-inter text-lg bg-gradient-to-r from-mint-500 to-lavender-500 text-white shadow-2xl hover:shadow-glow transition-all duration-300 button-hover focus-mint"
          >
